...
namespace Product
{
    public class Toolkit
    {
        ...
        public static string DateTimeNowToStringFormat
        {
            get; set;
        ...
        private static string NowToString(string format)
        {
        ...
        private static string MakeMessage(string header, string message)
        {
            ...
            {
#if DEBUG
                message = String.Format("[{0}] {1} [{2}] DEBUG - {3}", IncludeFilterName, NowToString(DateTimeNowToStringFormat), header, message);
#else
                message = String.Format("[{0}] {1} [{2}] TRACE - {3}", IncludeFilterName, NowToString(DateTimeNowToStringFormat), header, message);
#endif
            }
            else
            {
